...
(function () {
  ...
  const EN = {
    ...
    "⟳ Перезагрузить бота": "⟳ Restart bot",
    "Перезагрузить сервис бота? Веб-интерфейс переподключится через ~10 сек.": "Restart the bot service? The web UI will reconnect in ~10 s.",
    "Перезагружаю бота…": "Restarting the bot…",
    "Сервис перезапускается, страница переподключится…": "Service is restarting, the page will reconnect…",
